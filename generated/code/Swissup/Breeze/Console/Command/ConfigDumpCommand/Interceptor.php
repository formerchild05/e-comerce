<?php
namespace Swissup\Breeze\Console\Command\ConfigDumpCommand;

/**
 * Interceptor class for @see \Swissup\Breeze\Console\Command\ConfigDumpCommand
 */
class Interceptor extends \Swissup\Breeze\Console\Command\ConfigDumpCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Config\Model\ResourceModel\Config\Data\CollectionFactory $collectionFactory, \Magento\Framework\App\Config\ScopeCodeResolver $scopeCodeResolver, \Magento\Framework\App\DeploymentConfig $deploymentConfig, \Magento\Framework\App\Utility\Files $files, \Magento\Config\Console\Command\ConfigSet\ConfigSetProcessorFactory $configSetProcessorFactory, \Magento\Framework\Event\ManagerInterface $eventManager)
    {
        $this->___init();
        parent::__construct($collectionFactory, $scopeCodeResolver, $deploymentConfig, $files, $configSetProcessorFactory, $eventManager);
    }
