<?php
namespace Swissup\Breeze\Console\Command\ThemeCreateCommand;

/**
 * Interceptor class for @see \Swissup\Breeze\Console\Command\ThemeCreateCommand
 */
class Interceptor extends \Swissup\Breeze\Console\Command\ThemeCreateCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Swissup\Breeze\Console\Command\Stubs $stubs, \Magento\Framework\Filesystem $filesystem, \Symfony\Component\Console\Question\ConfirmationQuestionFactory $confirmationQuestionFactory, \Symfony\Component\Console\Question\QuestionFactory $questionFactory, \Symfony\Component\Console\Question\ChoiceQuestionFactory $choiceQuestionFactory, \Symfony\Component\Console\Helper\QuestionHelper $questionHelper, \Swissup\Breeze\Model\BreezeThemesProvider $breezeThemesProvider)
    {
        $this->___init();
        parent::__construct($stubs, $filesystem, $confirmationQuestionFactory, $questionFactory, $choiceQuestionFactory, $questionHelper, $breezeThemesProvider);
    }
