<?php
namespace Swissup\Breeze\Console\Command\ModuleCreateCommand;

/**
 * Interceptor class for @see \Swissup\Breeze\Console\Command\ModuleCreateCommand
 */
class Interceptor extends \Swissup\Breeze\Console\Command\ModuleCreateCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($stubs, $filesystem, $confirmationQuestionFactory, $questionFactory, $choiceQuestionFactory, $questionHelper);
    }
