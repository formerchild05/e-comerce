...
class Interceptor extends \Magento\Catalog\Block\Widget\RecentlyViewed implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderApp');
        return $pluginInfo ? $this->___callPlugins('renderApp', func_get_args(), $pluginInfo) : parent::renderApp($data);
    }
