...
class Interceptor extends \Magento\TwoFactorAuth\Model\TfaSession implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'grantAccess');
        $pluginInfo ? $this->___callPlugins('grantAccess', func_get_args(), $pluginInfo) : parent::grantAccess();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSkippedProviderConfig');
        return $pluginInfo ? $this->___callPlugins('getSkippedProviderConfig', func_get_args(), $pluginInfo) : parent::getSkippedProviderConfig();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSkippedProviderConfig');
        $pluginInfo ? $this->___callPlugins('setSkippedProviderConfig', func_get_args(), $pluginInfo) : parent::setSkippedProviderConfig($config);
    }
